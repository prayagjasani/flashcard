...
def translate_subtitles(subs: list[dict], only_missing: bool = False, max_duration_secs: int = 1500) -> list[dict]:
    """Translate German subtitle lines to English using Gemini AI.
    max_duration_secs caps translation to ~25 min of video at a time."""
    if not subs:
        return subs
